      ...
      <div className="mt-2 px-3 pb-3">
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <div className="flex gap-2">
            <div className="flex items-center justify-between gap-1 bg-[#b36f34]/10 p-2 rounded-sm">
              <button
                className="w-10 md:w-8 h-6 flex justify-center items-center disabled:opacity-30"
                onClick={() => {
            ...
            <button
              className="capitalize bg-[#b36f34] text-black w-10 flex items-center justify-center rounded-sm w font-bold text-lg hover:bg-[#e68f44] transition-all active:translate-y-0.5"
              onClick={() => {
